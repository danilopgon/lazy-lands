...
- [ ] 2.4.1 Playwright throttled-navigation sample. Not written: authoring it blind risks landing a
      flaky spec whose first run is CI. Needs a session with a usable browser.
