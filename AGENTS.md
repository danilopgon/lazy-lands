...
is MANDATORY. The workflow is: (1) read the handoff prototype file for that screen, (2) extract
a field-by-field checklist, (3) implement against the checklist, (4) perform adversarial
self-review comparing implementation vs handoff before declaring done. Implementations that
skip this workflow or deviate from the handoff without explicit justification are incomplete.
See `.agents/skills/frontend-handoff-contract/SKILL.md` for the full contract.
...
include the handoff checklist, the spec is incomplete.
